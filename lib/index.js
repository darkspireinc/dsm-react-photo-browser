...
export default class PhotoBrowser extends React.Component {
  ...
  static propTypes = {
    ...
    photoCount: PropTypes.oneOfType([
      PropTypes.number,
      PropTypes.bool
    ]),
  };
  ...
  render() {
    ...
    if(this.props.photoCount === false){
      this.state.photoText = mediaList.length;
    }
    else{
      this.state.photoText = this.props.photoCount;
    }
    return (
      <View style={[styles.container, {
        ...
        <TopBarComponent
          ...
          title={isFullScreen ? title : `${this.state.photoText} photos`}
          onBack={onBack}
        />
      </View>
    );
